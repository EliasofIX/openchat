...
function Icon({ size = 24, className, children, ...props }: IconProps & { children: ReactNode }) {
  return (
    <svg
...
export function AlertCircle({ size, className }: IconProps) {
  return (
...
export function Brain({ size, className }: IconProps) {
  return (
    <Icon size={size} className={className}>
...
export function Copy({ size, className }: IconProps) {
  return (
    <Icon size={size} className={className}>
...
export function FileCode2({ size, className }: IconProps) {
  return (
    <Icon size={size} className={className}>
...
export function HardDrive({ size, className }: IconProps) {
  return (
    <Icon size={size} className={className}>
...
export function KeyRound({ size, className }: IconProps) {
  return (
    <Icon size={size} className={className}>
...
export function Loader2({ size, className }: IconProps) {
  return (
    <Icon size={size} className={className}>
...
export function Settings({ size, className }: IconProps) {
  return (
    <Icon size={size} className={className}>
...
export function SquarePen({ size, className }: IconProps) {
  return (
    <Icon size={size} className={className}>
...
export function Trash2({ size, className }: IconProps) {
  return (
    <Icon size={size} className={className}>
      <path d="M3 6h18" />
...
export function Type({ size, className }: IconProps) {
  return (
    <Icon size={size} className={className}>
